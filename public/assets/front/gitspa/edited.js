...
//        function createPop(event){
//            var element = overlay.getElement();
//            element.innerHtml = feature.attributes.towns +" as been cleared" 
//        }
          ...
          function createPopup(feature) {
              ...
              popup = new GeoExt.Popup({
                     ...
                     width:100,
                     height: 100,
                     html : feature.attributes.towns+ " Is Cleared",
                     maximizable: false,
                     collapsible: false,
					     padding:'5 5 5 5'
                     //items:items[0]
...
//		);
        ...
        var mapPanel = Ext.create('GeoExt.panel.Map', {
            title: 'Geoserver Land Mine Points Viewer',
            map: map,
            border:false,
			//minWidth:'30%',
            fallThrough: true,
...
//                        type: 'hbox'
//                    },
//					html: '<h1>Buried Mines Detection</h1><h2>Detects buried landmine in any region</h2>',
//                    style:"background-image:url(app/images/world.jpg);font-size: 18px;text-align:center;color:#ffffff; !important"
//
//                }
                ]  
